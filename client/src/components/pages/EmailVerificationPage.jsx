      ...
      <div className="p-6">
            ...
            <motion.div key="step1" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="max-w-md mx-auto">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input type="email" value={email} onChange={handleEmailChange} placeholder="example@email.com" className="w-full px-5 py-4 border-2 border-blue-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg font-semibold shadow-sm" data-testid="input-email" />
                </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="mt-8 bg-gradient-to-br from-blue-100 to-purple-100 border-2 border-blue-200 rounded-2xl p-6 relative overflow-hidden">
          ...
          <div className="flex items-start space-x-4 relative z-10">
            ...
            <div>
              <h4 className="font-bold text-blue-900 mb-2 text-lg">メールアドレス認証について</h4>
