            ...
            >
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-blue-100">
                    ...
                    <ol className="list-decimal pl-6 space-y-4 text-gray-700 mb-8">
                        <li>
                            オンライン学習プラットフォーム「SIN JAPAN ONLINE SCHOOL」（以下「本サービス」といいます。）を運営する合同会社SIN JAPAN（以下「当社」といいます。）は、本サービスの利用者（以下「利用者」という）のプライバシーを尊重し、利用者の個人情報およびその他の利用者のプライバシーに係る情報（以下「プライバシー情報」といいます。）の管理に細心の注意を払います。
                        </li>
                        <li>
